...
export const INITIAL_STATIC_TEAM: TeamMemberRecord[] = [
  ...
  },
  {
    ...
    image_alt: 'Manoj - Business Development',
    bio: 'Business development lead focused on corporate setup, licensing strategy, and market entry.',
    email: 'manoj@ultronfinancials.com',
    phone: null,
    linkedin_url: null,
    social_url: null,
    show_email_publicly: false,
  ...
  },
  {
    ...
    image_alt: 'Virendra - Business Development',
    bio: 'Business development advisor assisting clients with company structuring and commercial licensing.',
    email: 'virendra@ultronfinancials.com',
    phone: null,
    linkedin_url: null,
    social_url: null,
    show_email_publicly: false,
