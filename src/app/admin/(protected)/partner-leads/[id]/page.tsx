...
import { EnquiryActionsForm } from '../../enquiries/[id]/EnquiryActionsForm';
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="inline-flex items-center gap-1 rounded-md bg-amber-100 px-2.5 py-0.5 text-xs font-bold text-amber-800 uppercase">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
        {/* Left Column (8 cols): Submitted Partner Information */}
        <div className="space-y-6 lg:col-span-8">
          {/* Submitted Message / Opportunity Details Card */}
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs">
            ...
            <div className="mt-4 rounded-lg border border-amber-100 bg-amber-50/50 p-4 font-mono text-sm leading-relaxed whitespace-pre-wrap text-slate-800">
              {enquiry.message || 'No additional message was submitted.'}
            </div>
          </div>

          {/* Partner Contact & Business Profile Grid */}
          <div className="space-y-6 rounded-xl border border-slate-200 bg-white p-6 shadow-xs">
            <h3 className="font-display flex items-center gap-2 border-b border-slate-100 pb-3 text-base font-bold text-slate-900 uppercase">
              ...
              Partner Contact & Business Details
            </h3>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <span className="mt-1 block text-base font-bold text-[#035551]">
                  {enquiry.service || 'General Partner'}
                </span>
              </div>
